...
:root {
    ...
    /* Components - Checkbox */
    --checkboxDefault: var(--colorDefault40, #3c3c3c);
    ...
    --toggleSuccess: var(--colorSuccess40, #00bc8c);
    --toggleCalm: var(--colorCalm40, #3498db);
    --toggleWarning: var(--colorWarning40, #f39c12);
    --toggleDanger: var(--colorDanger40, #e74c3c);
    --toggleLight: var(--colorLight50, #979ea5);
    ...
    --activeBackgroundLight: var(--colorLight30, #c3c9ce);
    ...
    --ionSegmentLight: var(--textColorLight30, #2d2d2d);
    ...
    --tabsDefault: var(--colorDefault40, #3c3c3c);
    --tabsPrimary: var(--colorPrimary40, #375a7f);
    --tabsSuccess: var(--colorSuccess40, #00bc8c);
    --tabsCalm: var(--colorCalm40, #3498db);
    --tabsWarning: var(--colorWarning40, #f39c12);
    --tabsDanger: var(--colorDanger40, #e74c3c);
    --tabsLight: var(--colorLight40, #adb5bd);
    ...
    --barLight: var(--colorLight40, #adb5bd);
    ...
    --backgroundDefault: var(--colorDefault40, #060606);
    --backgroundPrimary: var(--colorPrimary40, #2780e3);
    --backgroundSuccess: var(--colorSuccess40, #00bc8c);
    ...
    --backgroundLight: var(--colorLight40, #adb5bd);
...
.tabs-striped.tabs-icon-positive .tab-item.activated {
    color: var(--textColorDefault40, #ffffff);
...
.item .item-content.activated.item-complex>.item-content {
    ...
    border-color: var(--backgroundColor20, #afafaf);
}
