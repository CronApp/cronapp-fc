...
public static Var CalculateTeamPrice() throws Exception {
 return new Callable<Var>() {
   ...
   public Var call() throws Exception {
    ...
    cronapi.math.Operations.sum(total,
    cronapi.database.Operations.getField(myTeam,
    Var.valueOf("this[0].playerReserve1.price")),
    cronapi.database.Operations.getField(myTeam,
    Var.valueOf("this[0].playerReserve2.price")));
    total =
    cronapi.math.Operations.sum(total,
    cronapi.database.Operations.getField(myTeam,
    Var.valueOf("this[0].playerReserve3.price")),
    cronapi.database.Operations.getField(myTeam,
    Var.valueOf("this[0].playerReserve4.price")));
    return total;
   }
 }.call();
}
