...
:root {
    ...
    /* Components - Combobox */
    --comboboxDefault: var(--colorDefault40, #555555);
    ...
    --optionRoyal: var(--colorRoyal40, #9933cc);
    ...
    /* Components - Panel */
    --panelDefault: var(--colorPrimary40, #2a9fd6);
    --panelPrimary: var(--colorDefault40, #555555);
    ...
    --panelRoyal: var(--colorRoyal40, #9933cc);
...
.option-default .k-radio:hover+.k-radio-label::before {
    box-shadow: 0 0 5px 0 var(--colorDefault30, #909090);
    border-color: var(--colorDefault30, #909090);
}
...
.option-light .k-radio:hover+.k-radio-label::before {
    box-shadow: 0 0 5px 0 var(--colorLight30, #7f7f7f);
    border-color: var(--colorLight30, #7f7f7f);
}
...
.checkbox-default .k-checkbox:focus+.k-checkbox-label:before,
.checkbox-default .k-checkbox:hover+.k-checkbox-label:before {
    box-shadow: 0 0 5px 0 var(--colorDefault20, #b8b8b8);
}
...
.checkbox-light .k-checkbox:focus+.k-checkbox-label:before,
.checkbox-light .k-checkbox:hover+.k-checkbox-label:before {
    box-shadow: 0 0 5px 0 var(--colorLight20, #afafaf);
}
...
.modal-header,
.modal-footer {
    border-color: var(--colorDefault60, #3e3e3e);
}
...
.bg-login #container-second {
    background: linear-gradient(-140deg, var(--colorPrimary20, #b0d1ea), var(--colorPrimary30, #81bae0), var(--colorPrimary40, #2a9fd6), var(--colorPrimary50, #258bbb), var(--colorPrimary60, #1f749d));
}
...
.bg-login #container-first #crn-botao-signup:hover {
    color: var(--colorPrimary50, #258bbb);
}
...
.ctn-tab .nav-tabs li.active {
    border: 0;
    border-bottom: 1px solid var(--colorPrimary40, #2a9fd6);
...
/* input text whit icon */
.input-group .k-button {
    background: transparent;
    border: 0;
    padding: 14px 22px;
    color: var(--textColor40, #888888);
}
...
.bootstrap-datetimepicker-widget.dropdown-menu.top:after {
    border-top-color: var(--colorDefault70, #2f2f2f);
}
...
.dynamic-image-container .btn:hover {
    color: var(--textColorDefault40, #ffffff);
    background: var(--colorDefault50, #4a4a4a);
    border-color: transparent;
    outline: none;
}
...
.active-bar .btn.btn-default:hover {
    background: var(--colorSuccess50, #689d00);
    border-color: transparent;
    color: var(--textColorSuccess40, #ffffff);
}
...
.k-grid tr.k-state-selected:hover td {
    background: var(--backgroundColor50, #050505);
    color: var(--textColorDefault40, #ffffff);
}
...
.k-grid tr td {
    border-color: var(--colorDefault20, #b8b8b8);
    color: var(--textColorDefault40, #ffffff);
}
...
.k-grid tr.k-state-selected:hover td {
    background: var(--colorPrimary40, #2a9fd6);
    border-color: var(--colorPrimary30, #81bae0);
}
...
td.k-state-focused.k-state-selected {
    box-shadow: inset 0 0 2px 0 var(--colorPrimary30, #81bae0), inset 0 0 7px 0 var(--colorPrimary40, #2a9fd6);
    background: transparent;
}
...
.k-calendar .k-link {
    color: var(--colorDefault40, #555555);
}
...
.k-grid .k-pager-numbers .k-link:hover {
    background: var(--colorPrimary20, #b0d1ea);
    color: var(--textColorPrimary40, #ffffff);
    border-color: var(--colorPrimary20, #b0d1ea);
}
...
.k-scheduler-toolbar>ul>li {
    border-color: var(--colorDefault40, #555555);
    box-shadow: none;
}
...
.k-scheduler-timelineview .k-today.k-nonwork-hour {
    background: var(--backgroundColor10, #d5d5d5);
}
...
.k-today>.k-scheduler-groupcolumn {
    background: var(--backgroundColor20, #aeaeae);
}
...
.k-other-month .k-link {
    color: var(--colorDefault30, #555555);
}
...
.k-calendar td.k-state-focused {
    box-shadow: inset 0 0 10px 3px var(--colorDefault40, #555555);
}
